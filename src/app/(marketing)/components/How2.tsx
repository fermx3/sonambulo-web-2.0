...
export default function Process() {
  return (
    <div className="relative min-h-[20vh] md:min-h-[80vh] bg-[var(--color-ink)] overflow-hidden">
      {/* Three slanted strips (all use the same image) */}
      <FadeUp>
        <div className="relative w-full h-[50vh] md:h-[60vh] flex items-center justify-center font-(family-name:--font-montserrat) font-bold italic overflow-y-visible">
          {/* Top strip */}
          <div
        ...
        >
          <div className="relative w-[200vw] max-w-none">
            <div className="absolute w-[200vw] left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex items-center justify-center gap-3 lg:gap-6 bg-[var(--color-teal)] px-4">
              <span className="text-[1.2rem] md:text-[2.5rem] xl:text-[4.5rem] flex-shrink-0">
                1 <span className="hidden sm:inline-block">-</span>
              </span>
              <div className="text-[1rem] md:text-[2rem] xl:text-[4rem] text-center lg:text-left">
        ...
        {/* Middle strip */}
        <div
          className="absolute left-0 right-0 flex justify-center z-10 -translate-y-[2vh] -rotate-[2deg]"
          aria-hidden
        >
          <div className="relative w-[200vw] max-w-none">
            <div className="absolute w-[200vw] left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex items-center justify-center gap-3 lg:gap-6 bg-[var(--color-blue)] px-4">
              <span className="text-[1.2rem] md:text-[2.5rem]  xl:text-[4.5rem] text-[var(--color-white)] flex-shrink-0">
                2 <span className="hidden sm:inline-block">-</span>
              </span>
              <div className="text-[1rem] md:text-[2rem]  xl:text-[4rem] text-[var(--color-white)] text-center lg:text-left">
        ...
        {/* Bottom strip */}
        <div
          className="absolute left-0 right-0 flex justify-center translate-y-[6vh] md:translate-y-[22vh] rotate-[5deg]"
          aria-hidden
        >
          <div className="relative w-[200vw] max-w-none">
