          ...
          {images.length <= 2 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              {images.map((image, index) => (
                <div
                  key={index}
                  className="relative aspect-square w-[60vh] mx-auto overflow-hidden bg-gray-100"
                >
                  <Image
                    src={image.url}
            ...
            <div className="relative">
              <div className="relative aspect-square w-[60vh] mx-auto overflow-hidden bg-gray-100">
                <Image
