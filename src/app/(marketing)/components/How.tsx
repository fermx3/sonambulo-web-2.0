  ...
  return (
    <div className="relative bg-[var(--color-ink)] min-h-[200vh] flex items-center justify-center flex-col">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7">
            {/* imagen principal movida a la sección de 'manos' para que se solape correctamente */}
            <div className="mt-12">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end items-center">
            <div className="relative w-full max-w-[520px] lg:max-w-[600px]">
              ...
              <div
                className="absolute -right-6 bottom-[-20px] w-36 h-36 bg-[var(--color-lime)] rounded-full filter blur-sm opacity-90 pointer-events-none"
                aria-hidden
              />
            </div>
          </div>
      ...
      <div className="relative w-full h-[80dvh] flex">
        ...
        <div className="absolute inset-0 -top-[20vh] w-full h-[140vh] pointer-events-none">
          <Image
